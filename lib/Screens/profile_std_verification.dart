...
class ProfileStdVerification extends StatefulWidget {
  const ProfileStdVerification({super.key});

  @override
  State<ProfileStdVerification> createState() => _ProfileStdVerificationState();
}

class _ProfileStdVerificationState extends State<ProfileStdVerification> {
  @override
        ...
        body: SizedBox(
          ...
          child: Column(
            ...
            children: [
              ...
              Common.customElevatedButton(context, Constants.save, () {
                Navigator.of(context).pop();
              }, AppColors.greenchat),
            ],
          ),
